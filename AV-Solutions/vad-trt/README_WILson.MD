...
set platform of x86_64 in CMakeLists.txt 
cmake ..
...
# prepare Int8 calibrator cache in export_eval in x86_64-linux-gnu/
python generate_calib_cache.py \
        --demo-dir demo_data/ \
        --onnx-dir scratch/ \
        --output-dir scratch/calibration/ 
        --build-engine
